...
var _index = _interopRequireDefault(__webpack_require__("./src/index.js"));
...
var _index = __webpack_require__("./src/util/index.js");

var _compilerUtils = __webpack_require__("./src/compiler/compilerUtils.js");
...
function () {
  function Compiler(el, vm) {
    ...
    this.$vm = vm;
    this.$el = (0, _index.isElementNode)(el) ? el : document.querySelector(el);
  ...
  _createClass(Compiler, [{
    ...
    value: function compileElement(el) {
      ...
      [].slice.call(childNodes).forEach(function (node) {
        ...
        if ((0, _index.isElementNode)(node)) {
          me.compile(node);
        } else if ((0, _index.isTextNode)(node) && reg.test(text)) {
    ...
    value: function compile(node) {
      ...
      [].slice.call(nodeAttrs).forEach(function (attr) {
        ...
        if ((0, _index.isDirective)(attrName)) {
          var exp = attr.value;

          if ((0, _index.isEventDirective)(dir)) {
            _this.eventHandler(node, _this.$vm, exp, dir);
          } else {
            _compilerUtils.compilerUtils[dir] && _compilerUtils.compilerUtils[dir](node, _this.$vm, exp);
          }
    ...
    value: function compileText(node, exp) {
      _compilerUtils.compilerUtils.text(node, this.$vm, exp);
    }
  }, {
    key: "eventHandler",
...
exports.updater = exports.compilerUtils = void 0;

var _index = _interopRequireDefault(__webpack_require__("./src/watcher/index.js"));
...
compilerUtils = {
  ...
  bind: function bind(node, vm, exp, dir) {
    ...
    new _index.default(vm, exp, function (value, oldValue) {
  ...
  _setVmVal: function _setVmVal(vm, exp, newVal) {
    var val = vm;
    var exps = exp.split('.');
...
exports.compilerUtils = compilerUtils;
...
var _observer = __webpack_require__("./src/observer/observer.js");

var _compiler = _interopRequireDefault(__webpack_require__("./src/compiler/compiler.js"));

var _index2 = _interopRequireDefault(__webpack_require__("./src/watcher/index.js"));
...
function () {
  function VM() {
    ...
    var data = this._data = this.$options.data; // 数据代理
    ...
    this.$compile = new _compiler.default(options.el || document.body, this);
  }

  _createClass(VM, [{
    key: "$watch",
    value: function $watch(key, cb) {
      new _index2.default(this, key, cb);
    }
  }, {
    key: "_proxyData",
    value: function _proxyData(key) {
      var me = this;
    ...
    value: function _initComputed() {
      ...
      if ((0, _index.isObject)(computed)) {
        Object.keys(computed).forEach(function (key) {
          Object.defineProperty(_this2, key, {
            get: function get() {
              var com = computed[key];
              return (0, _index.isFunction)(com) ? com : com.get;
            },
            set: function set() {}
          });
        });
...
var _dep = _interopRequireDefault(__webpack_require__("./src/observer/dep.js"));
...
function () {
  ...
  _createClass(Observer, [{
    ...
    value: function defineReactive(obj, key, value) {
      ...
      if (value && (0, _index.isObject)(value)) {
        this.walk(value);
      }

      Object.defineProperty(obj, key, {
        get: function get() {
          var watcher = _dep.default.target;
        ...
        set: function set(newValue) {
          if (value !== newValue) {
            if (value && (0, _index.isObject)(newValue)) {
              me.walk(newValue);
            }
...
function () {
  function Watcher(vm, expOrFn, callback) {
    ...
    if ((0, _index.isFunction)(expOrFn)) {
      this.getter = expOrFn;
    } else {
  ...
  _createClass(Watcher, [{
    ...
    value: function run() {
      ...
      this.value = newVal; // 将newVal, oldVal挂载到MVVM实例上
    ...
    value: function get() {
      var value;
      _dep.default.target = this; // 强制执行监听器里的get函数
